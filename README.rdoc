...
YouTube demo: https://youtu.be/e-m5ggZ66xc

-Technologies:
Ruby on Rails, Javascript, JQuery, HTML 5, CSS 3, Bootstrap, PostgreSQL.
Github repositoy: https://github.com/jmartos/BrickAPP

-Video Demo:
https://youtu.be/e-m5ggZ66xc
